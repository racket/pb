/* equates.h for Chez Scheme Version 9.5.5.6 */
...
#define closure_code_disp -0x5
#define closure_data_disp 0x3
#define code_arity_mask_disp 0x19
...
#define code_length_disp 0x1
#define code_name_disp 0x11
#define code_pinfos_disp 0x31
#define code_reloc_disp 0x9
#define code_type_disp -0x7
...
#define continuation_attachments_disp 0x33
#define continuation_code_disp -0x5
#define continuation_link_disp 0x1B
#define continuation_return_address_disp 0x23
#define continuation_stack_clength_disp 0x13
#define continuation_stack_disp 0x3
#define continuation_stack_length_disp 0xB
#define continuation_winders_disp 0x2B
...
#define ephemeron_car_disp -0x1
#define ephemeron_cdr_disp 0x7
#define ephemeron_next_disp 0x17
#define ephemeron_prev_ref_disp 0xF
...
#define exactnum_pad_disp 0x11
#define exactnum_real_disp 0x1
#define exactnum_type_disp -0x7
...
#define flonum_data_disp -0x2
#define flvector_data_disp 0x1
#define flvector_length_factor 0x10
#define flvector_length_offset 0x4
#define flvector_type_disp -0x7
...
#define inexactnum_pad_disp 0x1
#define inexactnum_real_disp 0x9
#define inexactnum_type_disp -0x7
...
#define pair_car_disp -0x1
#define pair_cdr_disp 0x7
...
#define phantom_length_disp 0x1
#define phantom_type_disp -0x7
...
#define port_handler_disp 0x1
#define port_ibuffer_disp 0x31
#define port_icount_disp 0x11
#define port_ilast_disp 0x29
#define port_info_disp 0x39
#define port_name_disp 0x41
#define port_obuffer_disp 0x21
#define port_ocount_disp 0x9
#define port_olast_disp 0x19
#define port_type_disp -0x7
...
#define ratnum_numerator_disp 0x1
#define ratnum_pad_disp 0x11
#define ratnum_type_disp -0x7
...
#define record_data_disp 0x1
#define record_ptr_offset -0x7
#define record_type_ancestry_disp 0x1
#define record_type_counts_disp 0x41
#define record_type_disp -0x7
#define record_type_flags_disp 0x31
#define record_type_flds_disp 0x29
#define record_type_mpm_disp 0x19
#define record_type_name_disp 0x21
#define record_type_pm_disp 0x11
#define record_type_size_disp 0x9
#define record_type_type_disp -0x7
#define record_type_uid_disp 0x39
#define reference_disp 0x1
...
#define rtd_counts_data_disp 0x9
#define rtd_counts_timestamp_disp 0x1
#define rtd_counts_type_disp -0x7
...
#define scheme_version 0x9050506
...
#define thread_tc_disp 0x1
#define thread_type_disp -0x7
...
#define tlc_keyval_disp 0x1
#define tlc_next_disp 0x11
#define tlc_type_disp -0x7
...
#define type_untyped 0x0
#define type_vector 0x0
#define typed_object_type_disp -0x7
...
#define eq_hashtable_rtd_disp -7
#define eq_hashtable_type_disp 1
#define eq_hashtable_mutablep_disp 9
#define eq_hashtable_vec_disp 17
#define eq_hashtable_minlen_disp 25
#define eq_hashtable_size_disp 33
#define eq_hashtable_subtype_disp 41
#define symbol_hashtable_rtd_disp -7
#define symbol_hashtable_type_disp 1
#define symbol_hashtable_mutablep_disp 9
#define symbol_hashtable_vec_disp 17
#define symbol_hashtable_minlen_disp 25
#define symbol_hashtable_size_disp 33
#define symbol_hashtable_equivp_disp 41
#define code_info_rtd_disp -7
#define code_info_src_disp 1
#define code_info_sexpr_disp 9
#define code_info_free_disp 17
#define code_info_live_disp 25
#define code_info_rpis_disp 33

/* predicates */
#define Simmediatep(x) (((uptr)(x)&0x7)==0x6)
#define Sportp(x) ((((uptr)(x)&0x7)==0x7) &&\
    (((uptr)((*((ptr *)TO_VOIDP((uptr)(x)-7))))&0xFF)==0xCE))
#define Scodep(x) ((((uptr)(x)&0x7)==0x7) &&\
    (((uptr)((*((ptr *)TO_VOIDP((uptr)(x)-7))))&0xFF)==0x3E))

/* structure accessors */
#define INITCAR(x) (*((ptr *)TO_VOIDP((uptr)(x)-1)))
#define INITCDR(x) (*((ptr *)TO_VOIDP((uptr)(x)+7)))
#define SETCAR(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)-1)),(y))
#define SETCDR(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+7)),(y))
#define BOXTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define INITBOXREF(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define SETBOXREF(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+1)),(y))
#define EPHEMERONPREVREF(x) (*((ptr *)TO_VOIDP((uptr)(x)+15)))
#define INITEPHEMERONPREVREF(x) (*((ptr *)TO_VOIDP((uptr)(x)+15)))
#define EPHEMERONNEXT(x) (*((ptr *)TO_VOIDP((uptr)(x)+23)))
#define INITEPHEMERONNEXT(x) (*((ptr *)TO_VOIDP((uptr)(x)+23)))
#define TLCTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define TLCKEYVAL(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define TLCHT(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))
#define TLCNEXT(x) (*((ptr *)TO_VOIDP((uptr)(x)+17)))
#define INITTLCKEYVAL(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define INITTLCHT(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))
#define INITTLCNEXT(x) (*((ptr *)TO_VOIDP((uptr)(x)+17)))
#define SETTLCNEXT(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+17)),(y))
#define PHANTOMTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define PHANTOMLEN(x) (*((uptr *)TO_VOIDP((uptr)(x)+1)))
#define SYMVAL(x) (*((ptr *)TO_VOIDP((uptr)(x)+5)))
#define SYMPVAL(x) (*((ptr *)TO_VOIDP((uptr)(x)-3)))
#define SYMPLIST(x) (*((ptr *)TO_VOIDP((uptr)(x)+13)))
#define SYMNAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+21)))
#define SYMSPLIST(x) (*((ptr *)TO_VOIDP((uptr)(x)+29)))
#define SYMHASH(x) (*((ptr *)TO_VOIDP((uptr)(x)+37)))
#define INITSYMVAL(x) (*((ptr *)TO_VOIDP((uptr)(x)+5)))
#define INITSYMPVAL(x) (*((ptr *)TO_VOIDP((uptr)(x)-3)))
#define INITSYMPLIST(x) (*((ptr *)TO_VOIDP((uptr)(x)+13)))
#define INITSYMNAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+21)))
#define INITSYMSPLIST(x) (*((ptr *)TO_VOIDP((uptr)(x)+29)))
#define INITSYMHASH(x) (*((ptr *)TO_VOIDP((uptr)(x)+37)))
#define SETSYMVAL(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+5)),(y))
#define SETSYMPVAL(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)-3)),(y))
#define SETSYMPLIST(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+13)),(y))
#define SETSYMNAME(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+21)),(y))
#define SETSYMSPLIST(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+29)),(y))
#define SETSYMHASH(x,y) DIRTYSET(((ptr *)TO_VOIDP((uptr)(x)+37)),(y))
#define VECTTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define INITVECTIT(x,i) (((ptr *)TO_VOIDP((uptr)(x)+1))[i])
#define SETVECTIT(x,i,y) DIRTYSET((((ptr *)TO_VOIDP((uptr)(x)+1))+i),(y))
#define FXVECTOR_TYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define FXVECTIT(x,i) (((ptr *)TO_VOIDP((uptr)(x)+1))[i])
#define FLVECTOR_TYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define FLVECTIT(x,i) (((double *)TO_VOIDP((uptr)(x)+1))[i])
#define BYTEVECTOR_TYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define BVIT(x,i) (((octet *)TO_VOIDP((uptr)(x)+1))[i])
#define STENVECTTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define INITSTENVECTIT(x,i) (((ptr *)TO_VOIDP((uptr)(x)+1))[i])
#define INEXACTNUM_TYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define INEXACTNUM_REAL_PART(x) (*((double *)TO_VOIDP((uptr)(x)+9)))
#define INEXACTNUM_IMAG_PART(x) (*((double *)TO_VOIDP((uptr)(x)+17)))
#define EXACTNUM_TYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define EXACTNUM_REAL_PART(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define EXACTNUM_IMAG_PART(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))
#define EXACTNUM_PAD(x) (*((iptr *)TO_VOIDP((uptr)(x)+17)))
#define RATTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define RATNUM(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define RATDEN(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))
#define RATPAD(x) (*((iptr *)TO_VOIDP((uptr)(x)+17)))
#define CLOSENTRY(x) (*((ptr *)TO_VOIDP((uptr)(x)-5)))
#define CLOSIT(x,i) (((ptr *)TO_VOIDP((uptr)(x)+3))[i])
#define FLODAT(x) (*((double *)TO_VOIDP((uptr)(x)-2)))
#define PORTTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define PORTNAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+65)))
#define PORTHANDLER(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define PORTINFO(x) (*((ptr *)TO_VOIDP((uptr)(x)+57)))
#define PORTOCNT(x) (*((iptr *)TO_VOIDP((uptr)(x)+9)))
#define PORTOLAST(x) (*((ptr *)TO_VOIDP((uptr)(x)+25)))
#define PORTOBUF(x) (*((ptr *)TO_VOIDP((uptr)(x)+33)))
#define PORTICNT(x) (*((iptr *)TO_VOIDP((uptr)(x)+17)))
#define PORTILAST(x) (*((ptr *)TO_VOIDP((uptr)(x)+41)))
#define PORTIBUF(x) (*((ptr *)TO_VOIDP((uptr)(x)+49)))
#define STRTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define STRIT(x,i) (((string_char *)TO_VOIDP((uptr)(x)+1))[i])
#define BIGTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define BIGIT(x,i) (((bigit *)TO_VOIDP((uptr)(x)+1))[i])
#define CODETYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define CODELEN(x) (*((iptr *)TO_VOIDP((uptr)(x)+1)))
#define CODERELOC(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))
#define CODENAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+17)))
#define CODEARITYMASK(x) (*((ptr *)TO_VOIDP((uptr)(x)+25)))
#define CODEFREE(x) (*((iptr *)TO_VOIDP((uptr)(x)+33)))
#define CODEINFO(x) (*((ptr *)TO_VOIDP((uptr)(x)+41)))
#define CODEPINFOS(x) (*((ptr *)TO_VOIDP((uptr)(x)+49)))
#define CODEIT(x,i) (((octet *)TO_VOIDP((uptr)(x)+57))[i])
...
#define CONTCODE(x) (*((ptr *)TO_VOIDP((uptr)(x)-5)))
#define CONTSTACK(x) (*((ptr *)TO_VOIDP((uptr)(x)+3)))
#define CONTLENGTH(x) (*((iptr *)TO_VOIDP((uptr)(x)+11)))
#define CONTCLENGTH(x) (*((iptr *)TO_VOIDP((uptr)(x)+19)))
#define CONTLINK(x) (*((ptr *)TO_VOIDP((uptr)(x)+27)))
#define CONTRET(x) (*((ptr *)TO_VOIDP((uptr)(x)+35)))
#define CONTWINDERS(x) (*((ptr *)TO_VOIDP((uptr)(x)+43)))
#define CONTATTACHMENTS(x) (*((ptr *)TO_VOIDP((uptr)(x)+51)))
#define RTDCOUNTSTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define RTDCOUNTSTIMESTAMP(x) (*((U64 *)TO_VOIDP((uptr)(x)+1)))
#define RTDCOUNTSIT(x,i) (((uptr *)TO_VOIDP((uptr)(x)+9))[i])
#define RECORDDESCANCESTRY(x) (*((ptr *)TO_VOIDP((uptr)(x)+1)))
#define RECORDDESCSIZE(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))
#define RECORDDESCPM(x) (*((ptr *)TO_VOIDP((uptr)(x)+17)))
#define RECORDDESCMPM(x) (*((ptr *)TO_VOIDP((uptr)(x)+25)))
#define RECORDDESCNAME(x) (*((ptr *)TO_VOIDP((uptr)(x)+33)))
#define RECORDDESCFLDS(x) (*((ptr *)TO_VOIDP((uptr)(x)+41)))
#define RECORDDESCFLAGS(x) (*((ptr *)TO_VOIDP((uptr)(x)+49)))
#define RECORDDESCUID(x) (*((ptr *)TO_VOIDP((uptr)(x)+57)))
#define RECORDDESCCOUNTS(x) (*((ptr *)TO_VOIDP((uptr)(x)+65)))
#define RECORDINSTTYPE(x) (*((ptr *)TO_VOIDP((uptr)(x)-7)))
#define RECORDINSTIT(x,i) (((ptr *)TO_VOIDP((uptr)(x)+1))[i])
...
/* threads */
#define THREADTYPE(x) (*((iptr *)TO_VOIDP((uptr)(x)-7)))
#define THREADTC(x) (*((uptr *)TO_VOIDP((uptr)(x)+1)))

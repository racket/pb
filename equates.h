/* equates.h for Chez Scheme Version 9.5.5.2 */
...
#define header_size_stencil_vector 0x10
...
#define scheme_version 0x9050502
...
#define stencil_vector_data_disp 0x11
#define stencil_vector_length_offset 0x6
#define stencil_vector_mask_bits 0x3B
#define stencil_vector_mask_disp 0x9
...
#define INITSTENVECTIT(x,i) (((ptr *)TO_VOIDP((uptr)(x)+17))[i])
#define STENVECTMASK(x) (*((ptr *)TO_VOIDP((uptr)(x)+9)))

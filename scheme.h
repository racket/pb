/* scheme.h for Chez Scheme Version 9.5.5.2 (pb) */
...
#define Sstencil_vector_length(x) ((iptr)((uptr)(*((iptr *)TO_VOIDP((uptr)(x)+1)))>>6))
#define Sstencil_vector_ref(x,i) (((ptr *)TO_VOIDP((uptr)(x)+17))[i])
